...
This fork is playing with stylus implementation and more ideas and is not a 1:1 copy
of the original CSS Skeleton work by Dave Gamache. 
...
- Clone the repo: `git clone https://github.com/derandreas/Skeleton.git` (Note: this is under active development)
...
you have a release in the `/dist/` folder.
...
All parts of Skeleton are free to use and abuse under the [open-source MIT license](https://github.com/derandreas/Skeleton/blob/master/LICENSE.md).
